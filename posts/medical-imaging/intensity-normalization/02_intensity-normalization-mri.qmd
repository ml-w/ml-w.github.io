...
Apart from the standard normalization techniques covered in the [previous post](./01_intensity-normalization-toc.qmd), there are some techniques specifically designed to normalize MRI. I will go over some of the well-established method in this post, categorized based on scan region.
